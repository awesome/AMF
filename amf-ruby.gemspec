...
Gem::Specification.new do |s|
  ...
  s.require_paths = ["lib"]
  s.authors = ["RobertLongIV", "So Awesome Man"]
  s.date = "2017-06-19"
  s.description = "Ruby Gem for serializing and deserializing AMF"
  s.email = "callme@1800AWESO.ME"
  s.executables = ["amf"]
  s.extra_rdoc_files = ["History.txt", "Manifest.txt", "README.md", "History.txt"]
  s.files = [".autotest", ".hoeignore", "Gemfile", "History.txt", "LICENSE", "Manifest.txt", "README.md", "Rakefile", "bin/amf", "lib/amf.rb", "lib/amf/constants.rb", "lib/amf/deserializer.rb", "lib/amf/header.rb", "lib/amf/message.rb", "lib/amf/serializer.rb", "lib/amf/version.rb", "test/test_amf.rb"]
  s.homepage = "https://github.com/awesome/amf-ruby"
  s.licenses = ["Apache 2.0"]
  s.rdoc_options = ["--title", "amf-ruby", "--markup", "markdown", "--quiet"]
  s.required_ruby_version = Gem::Requirement.new(">= 1.9.2")
  s.rubygems_version = "2.2.5"
  s.summary = "Ruby Gem for serializing and deserializing AMF"
